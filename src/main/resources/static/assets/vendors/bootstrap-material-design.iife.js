         ...
         */var Carousel = function ($) {
             ...
             */var Carousel = function () {
                ...
                _createClass(Carousel, [{
                    ...
                    key: 'nextWhenVisible', value: function nextWhenVisible() {// Don't call next when the page isn't visible
                        if (!document.hidden) {
                            this.next();
                        }
                    }
         ...
         */var Collapse = function ($) {
             ...
             */var Collapse = function () {
                ...
                _createClass(Collapse, [{
                    ...
                    key: '_getTargetFromElement', value: function _getTargetFromElement(element) {
                        var selector = Util.getSelectorFromElement(element);
         ...
         */var Modal = function ($) {
             ...
             */var Modal = function () {
                ...
                _createClass(Modal, [{
                    ...
                    key: '_getScrollbarWidth', value: function _getScrollbarWidth() {// thx d.walsh
                    ...
                    key: '_jQueryInterface', value: function _jQueryInterface(config, relatedTarget) {
                        return this.each(function () {
                            var data = $(this).data(DATA_KEY);
             ...
             */var ScrollSpy = function () {
                ...
                _createClass(ScrollSpy, [{
                    ...
                    key: '_activate', value: function _activate(target) {
                        ...
                        } else {// todo (fat) this is kinda sus...
             ...
             */var Tab = function () {
                ...
                _createClass(Tab, [{
                    ...
                    value: function show() {
                        ...
                        var complete = function complete() {
                            var hiddenEvent = $.Event(Event.HIDDEN, {relatedTarget: _this15._element});
                    ...
                    key: '_activate', value: function _activate(element, container, callback) {
         ...
         */
             ...
             */var Tooltip = function () {
                ...
                _createClass(Tooltip, [{
                    ...
                    key: 'setElementContent', value: function setElementContent($element, content) {
                    ...
                    key: '_getAttachment', value: function _getAttachment(placement) {
