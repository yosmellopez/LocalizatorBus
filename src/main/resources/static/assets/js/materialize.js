    ...
    $(document).ready(function () {
        ...
        $(document).on('click.card', '.card', function (e) {
            if ($(this).find('> .card-reveal').length) {
                ...
                if ($(e.target).is($('.card-reveal .card-titulo')) || $(e.target).is($('.card-reveal .card-titulo i'))) {
...
(function (factory) {
    ...
    DatePicker.prototype.nodes = function (isOpen) {
        ...
        var calendar = this,
            ...
            tableHead = function (collection, fullCollection) {
                ...
                return _.node('thead', _.node('tr', _.group({
                    ...
                    item: function (counter) {
                        return [collection[counter], settings.klass.weekdays, 'scope=col titulo="' + fullCollection[counter] + '"'];
                    }
                }))); //endreturn
            ...
            createMonthNav = function (next) {
                ...
                }) + ' ' + 'titulo="' + (next ? settings.labelMonthNext : settings.labelMonthPrev) + '"'); //endreturn
            },
            //createMonthNav
            ...
            createMonthLabel = function (override) {
                ...
                if (settings.selectMonths && override == undefined) {
                    ...
                    }), settings.klass.selectMonth + ' browser-default', (isOpen ? '' : 'disabled') + ' ' + _.ariaAttr({controls: calendar.$node[0].id + '_table'}) + ' ' + 'titulo="' + settings.labelMonthSelect + '"');
                }
            ...
            createYearLabel = function (override) {
                ...
                if (numberYears) {
                    ...
                    if (settings.selectYears && override == undefined) {
                        ...
                        }), settings.klass.selectYear + ' browser-default', (isOpen ? '' : 'disabled') + ' ' + _.ariaAttr({controls: calendar.$node[0].id + '_table'}) + ' ' + 'titulo="' + settings.labelYearSelect + '"');
                    }
                }
    ...
    DatePicker.defaults = function (prefix) {
        ...
        return {
            ...
            // The titulo label to use for the month nav buttons
            labelMonthNext: 'Next month',
            labelMonthPrev: 'Previous month',

            // The titulo label to use for the dropdown selectors
        ...
        init: function (options) {
            ...
            return this.each(function (i) {
                ...
                var images, item_width, item_height, offset, center, pressed, dim, count, reference, referenceY,
                    amplitude, target, velocity, scrolling, xform, frame, timestamp, ticker, dragged,
                    vertical_dragged;
