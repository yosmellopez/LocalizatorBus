    ...
    var
                    ...
                    _.group({
                        ...
                        item: function( counter ) {
                            return [
                                ...
                                'scope=col titulo="' + fullCollection[ counter ] + '"'
                            ]
                        }
                    })
                )
        ...
        createMonthNav = function( next ) {
            ...
            return _.node(
                ...
                'titulo="' + (next ? settings.labelMonthNext : settings.labelMonthPrev ) + '"'
            ) //endreturn
        }, //createMonthNav
        ...
        createMonthLabel = function(override) {
            ...
            if ( settings.selectMonths  && override == undefined) {
                ...
                return _.node( 'select',
                    ...
                    'titulo="' + settings.labelMonthSelect + '"'
                )
            }
            ...
            if ( numberYears ) {
                ...
                if ( settings.selectYears  && override == undefined ) {
                    return _.node( 'select',
                        ...
                        'titulo="' + settings.labelYearSelect + '"'
                    )
                }
            }
